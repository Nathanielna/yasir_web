...
// 	}
// 	//插入日志
// 	d := models.IerSystOperationLog{}
// 	d.Url = c.Ctx.Request.RequestURI
// 	d.Urlmodel = c.controllerName + "." + c.actionName
// 	d.Userid = c.curUser.Id
// 	d.Operationdate = time.Now()
// 	d.Ip = c.Ctx.Request.RemoteAddr
// 	d.Data =  string(c.Ctx.Input.RequestBody)
// 	o := orm.NewOrm()
// 	go o.Insert(&d);
// }
